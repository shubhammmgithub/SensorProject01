...
class DataIngestion:
    ...
    def export_data_into_featured_store_file_path(self)->pd.DataFrame:
    ...
    def  initiate_data_ingestion(self) ->Path:
        logging.info("Entered intitiated_data_ingestion method of data_ingeston class ")
        
        try:
            feature_store_file_path = self.export_data_into_featured_store_file_path()
